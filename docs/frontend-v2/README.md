...
| 授课对象确认 | `docs/frontend-v2/course-create-audience.md` | 已实现，待用户验收 |
| 故事大纲 | `docs/frontend-v2/course-create-story-outline.md` | 旧草稿，待按新架构重新确认 |
...
每次只确认和实现一个模块。当前开发范围仅包含人物档案和授课对象确认。
