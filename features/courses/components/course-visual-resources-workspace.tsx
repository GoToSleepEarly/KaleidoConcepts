      ...
      <div className="flex flex-1 items-center gap-3 bg-[#F8FBFE] px-3 py-3">
        ...
        <div className="flex min-w-0 flex-1 flex-col items-center justify-center text-center" data-testid={`character-card-copy-${character.characterId}`}>
          ...
          {person ? (
            ...
            <>
              {character.sourceType === "original" && character.identityDescription ? (
                <div className="mt-2 w-full rounded-md bg-slate-100/80 px-2.5 py-2">
                  <p className="text-xs font-semibold text-[#60729A]">本体设定</p>
                  <p className="mt-1 line-clamp-3 text-pretty text-sm leading-5 text-[#38536E]">{character.identityDescription}</p>
                </div>
              ) : null}
              <div className="mt-2 w-full">
                <p className="text-xs font-semibold text-[#60729A]">稳定外观</p>
