...
export function SlideShotText({ page, mode, courseId, canEdit, selected, onSelect, autoFitScaleMax }: Props) {
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center slide-text-box">
        <AutoFitTextBox
          ...
          fitKey={`${page.id}:${textBox.fontSize}:${textBox.opacity}:${autoFitScaleMax ?? 1}`}
        >
