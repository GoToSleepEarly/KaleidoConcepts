...
import { CourseContentConflictError, generateCourseExercises } from "@/lib/server/repositories/course-content";
...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  try { return NextResponse.json(await generateCourseExercises(getDb(), id, key, createCourseContentGenerationDeps(), { regenerate })); }
  catch (error) {
