...
export const storyComplexityRegressionCases: StoryComplexityRegressionCase[] = [
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "合作",
      estimatedEnglishWordsPerChapter: 115,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "独立判断",
      estimatedEnglishWordsPerChapter: 210,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "自我效能",
      estimatedEnglishWordsPerChapter: 95,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "成长型思维",
      estimatedEnglishWordsPerChapter: 165,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "独立判断",
      estimatedEnglishWordsPerChapter: 205,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "独立判断",
      estimatedEnglishWordsPerChapter: 225,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "边界",
      estimatedEnglishWordsPerChapter: 160,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "同理心",
      estimatedEnglishWordsPerChapter: 230,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "同理心",
      estimatedEnglishWordsPerChapter: 75,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "独立判断",
      estimatedEnglishWordsPerChapter: 155,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "自我效能",
      estimatedEnglishWordsPerChapter: 78,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "成长型思维",
      estimatedEnglishWordsPerChapter: 135,
    },
  ...
  regressionCase({
    ...
    sample: {
      ...
      growthCore: "同理心",
      estimatedEnglishWordsPerChapter: 235,
    },
