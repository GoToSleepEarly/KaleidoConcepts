      ...
      updateCourseAudience(
        {
          ...
          courseStoryChatMessage: { findFirst: async () => null },
          courseStoryDirection: { findFirst: async () => null },
          courseSourceReference: { findFirst: async () => null },
          courseStoryOutline: { findFirst: async () => null },
          courseStorySetting: { findFirst: async () => null },
          courseCharacter: { findFirst: async () => null },
          courseTeachingPlan: { findFirst: async () => ({ courseId: "course-1" }) },
          courseContentChatMessage: { findFirst: async () => null },
          courseContentGeneration: { findFirst: async () => null },
          courseLessonContent: { findFirst: async () => null },
          courseImage: { findFirst: async () => null },
          courseVisualImageSlot: { findFirst: async () => null },
          courseCharacterVisual: { findFirst: async () => null },
          courseVisualResourcePlan: { findFirst: async () => null },
          coursePresentation: { findFirst: async () => null },
        } as unknown as CoursesDb,
        "course-1",
        input,
        false,
